...
data = [Row("Murilo","Biss",25,[10,56,43,20],{"status":"Inactive"}), 
        Row("Juliano","Moutinho",29,[18,50,32],{"status":"Active"}), 
        Row("Fernando","Grandini",29,[18,50,32],{"status":"Active"}), 
        Row("Lucas","Ramos",30,[60,87,3],{"status":"Active"}) 
      ]
